...
public class UserInput {
    ...
    // 8.1 - Example of reading/writing data from the console.
    ...
    public GameElements.Move convertInputToMove(char move) {
        //2.1 & 2.5 - Example of 5 lamda expression and example of object comparison.
        switch (move) {
            case 'w' -> {
                return UP;
            }
